...
- Positsioneerimine, popupi avamine/sulgemine, triggerid ja layouti k�itumine tuleb teha ainult HTML/CSS lahendustega.
- JS-i ei tohi kasutada kriitilise UI jaoks (nt ringi X/Y paigutus, popup trigger), kui kasutaja pole seda otseselt lubanud.
- Eelistada ankur + :target v�i muud puhast CSS/HTML mustrit, mis t��tab ka siis, kui script ei k�ivitu.
